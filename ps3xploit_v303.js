...
function dex()
{
	switch (fwVersion) {
		...
		case "4.89":
			if(document.getElementById('dex').checked===true){loadcex_489();}//alert("calling loaddex_484");
			else {loadcex_489();}
			disable_trigger();
			break;
...
function ps3chk(){
	...
	var fwCompat = ["4.00","4.10","4.11","4.20","4.21","4.25","4.30","4.31","4.40","4.41","4.45","4.46","4.50","4.53","4.55","4.60","4.65","4.66","4.70","4.75","4.76","4.78","4.80","4.81","4.82","4.83","4.84","4.85","4.87","4.89"];
	var ua = navigator.userAgent;
